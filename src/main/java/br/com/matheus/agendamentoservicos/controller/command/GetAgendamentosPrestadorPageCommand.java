...
public class GetAgendamentosPrestadorPageCommand implements Command {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response)
		...
		var id = ((Prestador) session.getAttribute("prestador")).getId();
		...
		var agendamentos = daoAgendamento.buscarAgendamentosPrestador(id);
		...
		return "agendamentos-prestador.jsp";
	}
